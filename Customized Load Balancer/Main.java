...
public class Main {
        ...
        static {
                ...
                instances[0] = new DataCenterInstance("First", "http://dc11vm.eastus.cloudapp.azure.com");
                instances[1] = new DataCenterInstance("Second", "http://dc12vm.eastus.cloudapp.azure.com");
                instances[2] = new DataCenterInstance("Third", "http://dc13vm.eastus.cloudapp.azure.com");
        }
