/*
 * Load Balancer Combined Round-Robin and CPU Utilization for Task 2
 *
 * Hao Wang - haow2
 *
*/
...
public class LoadBalancer {
        ...
        private static List<Integer> dead_dc_index;

        // Record the number of dc and lg
        private static int num_dc = 10;
        ...
        public void start() throws IOException, InterruptedException {
                ...
                int left_times = 9; // Check CPU status every several loops
                int check_health_wait = 81; // Check health of a DC every several loops
                int i = 0;
                dead_dc_index = new ArrayList<Integer>();
                ...
                while (true) {
                        ...
                        System.out.println("i: " + i + " left_times: " + left_times);
        ...
        private void checkHealth() throws IOException, InterruptedException {
                ...
                for (int i = 0; i < INSTANCE_NUM; i++) {
                        // Check Status
                        URL url = new URL(instances[i].getUrl());
                        int response_code;
                        HttpURLConnection url_conn;

                        // Double check each DC in case of making mistakes
                        
                        // First check
                        Thread.sleep(100);
                        url_conn = (HttpURLConnection) url.openConnection();
                        response_code = url_conn.getResponseCode();
                        System.out.println("First Time, The response code is: " + response_code);
                        ...
                        url_conn = (HttpURLConnection) url.openConnection();
                        response_code = url_conn.getResponseCode();
                        System.out.println("Second Time, The response code is: " + response_code);
